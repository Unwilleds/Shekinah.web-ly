        ...
        <div class="site-footer">
            ...
            <div class="site-link-group">
                <ul class="social-links">
                    <li>
                        <a class="socials" href="https://www.facebook.com/shekinaheventsplace" target="_blank"><i class="fa-brands fa-facebook"></i></a>
                    </li>
                    <li>
                        <a class="socials" href="https://www.instagram.com/shekinaheventsplace/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                    </li>
                </ul>
            </div>
        </div>
